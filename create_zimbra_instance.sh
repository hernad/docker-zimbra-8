...
VOL_ZIMBRA_DB=$(pwd)/zimbra/db
VOL_ZIMBRA_DB_SESSION=/opt/zimbra/db
...
VOL_ZIMBRA_CLAMAV=$(pwd)/zimbra/data/clamav
VOL_ZIMBRA_CLAMAV_SESSION=/opt/zimbra/data/clamav

VOL_ZIMBRA_AMAVISD=$(pwd)/zimbra/data/amavisd
VOL_ZIMBRA_AMAVISD_SESSION=/opt/zimbra/data/amavisd

VOL_ZIMBRA_LDAP=$(pwd)/zimbra/data/ldap
VOL_ZIMBRA_LDAP_SESSION=/opt/zimbra/data/ldap
